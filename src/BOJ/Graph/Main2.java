...
public class Main2 {
    ...
    public static void main(String[] args)throws IOException {
        ...
        //토마토는 한턴에 상하좌우 4개 영향
        //그래프에서 1인 좌표 모두 큐에 넣는다.
        //q 원소 개수만큼 순회하고, 전파가 이루어졌다면 turnCnt++
        //좌표마다 순회하면서 0인 것, visited false 인 것 큐 넣기
        //종료: 큐1이 비었을 때
    ...
    private static void bfs(int[][] box,boolean[][] visited, Queue<int[]> q,int m,int n){
